<%-- 
    Document   : bikip
    Created on : Nov 5, 2018, 3:43:27 AM
...
<head>
	...
	<link rel="stylesheet" href="./css/bikip.css">
...
<body>
	<div class="container">
		...
		<div class="jumbotron">
			<h2>"Qua sông phải bắc cầu Kiều, muốn con hay chữ phải yêu lấy thầy"</h2>
			<p>Hãy chăm chỉ và hiểu được cách học, cách thi của mỗi thầy cô.</p>
		</div>
		
		<div class="search">
			<div class="dropdown">
				<button type="button" class="btn btn-outline-secondary dropdown-toggle" data-toggle="dropdown">Chọn khoa</button>
				<div class="dropdown-menu">
					<a class="dropdown-item" href="#">Khoa CNTT</a>
					<a class="dropdown-item" href="#">Khoa Cơ bản</a>
					<a class="dropdown-item" href="#">Khoa Công nghệ Đa Phương Tiện</a>
				</div>
			</div>
		...
		<div class="row featurette">
			<div class="col-md-7">
				<h2 class="featurette-heading">Thầy Đỗ Ngọc Hùng </h2>
				<p class="lead">Rất trẻ, đẹp trai và vui tính, gần gũi học trò. Thầy rất thương sinh viên vất vả nên điểm khá cao...</p>
			</div>
			<div class="col-md-5">
