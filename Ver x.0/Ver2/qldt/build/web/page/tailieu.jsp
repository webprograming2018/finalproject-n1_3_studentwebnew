<%-- 
    Document   : tailieu
    Created on : Nov 5, 2018, 3:45:02 AM
...
<body>
	<div class="container">
			...
			<header class="blog-header py-3">
				<div class="row flex-nowrap justify-content-between align-items-center">
					...
					<div class="col-4 d-flex justify-content-end align-items-center">
						...
						<a class="btn btn-sm btn-outline-secondary" href="#">Đăng nhập</a>
					</div>
				</div>
			</header>
		...
		<footer class="blog-footer">
			<p>Trang web xây dựng cho <a href="https://getbootstrap.com/">Sinh viên PTIT </a> bởi <a href="https://twitter.com/mdo"> Sinh viên PTIT</a>.</p>
			<p>
